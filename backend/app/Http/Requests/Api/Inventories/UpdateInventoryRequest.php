...
class UpdateInventoryRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        $inventoryId = $inventory instanceof Inventory ? $inventory->getKey() : null;
        ...
        return [
            ...
            'status' => ['sometimes', 'string', Rule::in(Inventory::STATUSES)],
            'last_service_at' => ['sometimes', 'nullable', 'date', 'before_or_equal:now'],
